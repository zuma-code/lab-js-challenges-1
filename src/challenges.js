...
const numbers3 = [1, 2, 5, 10, 13, 50];
function multiplyBy(numbers3, multiplier) {
  let result = []; 
...
console.log(multiplyBy(numbers3, 2)); 
//console.log(multiplyBy(numbers3, 0.5)); 
...
leconsole.log(filterOut(original, toRemove)); 
